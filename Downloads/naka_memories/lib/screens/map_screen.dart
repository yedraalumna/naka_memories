...
class _MapScreenState extends State<MapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (themeProvider.isDarkMode) {
      appBarBackgroundColor = backgroundDark;
      appBarTextColor = textDarkMode;
    } else {
      appBarBackgroundColor = Colors.white;
      appBarTextColor = pinkDark;
    }
    ...
    if (_isWeb) {
      ...
      return Scaffold(
        appBar: AppBar(
          title: Text('Memory Places', style: TextStyle(color: appBarTextColor, fontWeight: FontWeight.bold)),
